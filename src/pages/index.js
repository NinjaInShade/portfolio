...
import LogoOverlayPattern from '../assets/bg pattern.svg';
import LaptopImg from '../assets/header image.png';
              ...
              <div className='header-img-inner-container'>
                ...
                <ul className='header-socials-container'>
                  <li className='header-social'>
                    <a href='https://github.com/NinjaInShade' target='_blank_' rel='noreferrer'>
                  ...
                  <li className='header-social'>
                    <a href='https://www.instagram.com/thefrontendguy/' target='_blank_' rel='noreferrer'>
                  ...
                  <li className='header-social'>
                    <a href='https://www.linkedin.com/in/leonmichalak/' target='_blank_' rel='noreferrer'>
                      <svg width='20' height='18' viewBox='0 0 20 18' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path
                  ...
                  <li className='header-social'>
                    <a href='https://twitter.com/TheFrontendGuyX' target='_blank_' rel='noreferrer'>
