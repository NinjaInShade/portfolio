...
export const projects = [
  {
    ...
    tags: ['HTML', 'CSS', 'Javascript', 'ReactJS', 'NodeJS', 'Full Stack', 'API', 'Database', 'Multi Page'],
    imgSrc: OnlineShop,
    imgAlt:
  ...
  },
  {
    ...
    github: 'https://github.com/NinjaInShade/4card-feature-section',
    tags: ['HTML', 'CSS', 'Javascript', 'ReactJS', 'NodeJS', 'Full Stack', 'Full Page', 'API', 'Database'],
    imgSrc: SiteBuild,
