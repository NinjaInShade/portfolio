...
export const projects = [
  ...
  },
  {
    ...
    tabs: ['HTML', 'CSS', 'Javascript', 'Landing Page', 'Full Page'],
  ...
  },
  {
    ...
    tabs: ['HTML', 'CSS', 'Landing Page', 'Full Page'],
  ...
  },
  {
    ...
    tabs: ['HTML', 'CSS', 'Javascript', 'Full Page'],
  ...
  },
  {
    ...
    github: 'https://github.com/NinjaInShade/4card-feature-section',
    tabs: ['HTML', 'CSS', 'Javascript', 'ReactJS', 'NodeJS', 'Full Stack', 'Full Page', 'API', 'Database'],
    imgSrc: SiteBuild,
