        ...
        <section className='project-card-content-container'>
          ...
          <footer className='project-card-footer'>
            <div className='project-card-links'>
              <a aria-label='Live site' href={liveSite} className='project-card-link' target='_blank' rel='noreferrer'>
              ...
              <a aria-label='Github' href={github} className='project-card-link' target='_blank' rel='noreferrer'>
